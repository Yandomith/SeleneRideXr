...
public class PrometeoEditor : Editor{
  ...
  private void OnEnable(){
    ...
    moveAction = SO.FindProperty("moveAction");
    handbrakeAction = SO.FindProperty("handbrakeAction");
  ...
  public override void OnInspectorGUI(){
    ...
    GUILayout.Space(25);
    GUILayout.Label("NEW INPUT SYSTEM", EditorStyles.boldLabel);
    GUILayout.Space(10);
    
    EditorGUILayout.PropertyField(moveAction, new GUIContent("Move Action: "));
    EditorGUILayout.PropertyField(handbrakeAction, new GUIContent("Handbrake Action: "));
